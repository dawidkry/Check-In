...
# 5. The Grid (Constructed with tiny, unbreakable strings)
h = []
h.append('<div style="display:grid; grid-template-columns:1fr 1fr; gap:12px; font-family:sans-serif;">')

# WhatsApp
h.append(f'<a href="whatsapp://send?text={encoded_msg}" target="_top" style="text-decoration:none;">')
...
# iMessage
h.append(f'<a href="sms:&body={encoded_msg}" target="_top" style="text-decoration:none;">')
...
# Viber
h.append(f'<a href="viber://forward?text={encoded_msg}" target="_top" style="text-decoration:none;">')
...
# Messenger
h.append('<div onclick="share()" style="background-color:#00
